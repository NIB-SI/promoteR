...
query1 = GRanges(seqnames=subject1@seqnames, 
                ranges=IRanges(start=subject1@ranges@start - 1000, 
                               width=1000),
...
d$subject_start_plus = d$subject_start - 1000
d$subject_end_plus = d$subject_end + 1000
d$query_start_plus = d$query_start - 1000
d$query_end_plus = d$query_end + 1000
...
file.output.name = 'potential_1000ntpromotor_overlaping_genes.xlsx'
